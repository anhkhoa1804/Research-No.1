...
ARGS=(
  ...
  --lambda_relationness_rank "${LAMBDA_RELATIONNESS_RANK:-0.0}"
  ...
  --lambda_object_bridge "${LAMBDA_OBJECT_BRIDGE:-0.0}"
  --object_bridge_topk "${OBJECT_BRIDGE_TOPK:-5}"
  --object_bridge_vocab_max_size "${OBJECT_BRIDGE_VOCAB_MAX_SIZE:-512}"
  --object_bridge_vocab_scan_rows "${OBJECT_BRIDGE_VOCAB_SCAN_ROWS:-20000}"
  ...
  --triplet_rank_scope "${TRIPLET_RANK_SCOPE:-all}"
