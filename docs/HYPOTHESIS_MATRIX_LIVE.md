...
raised WPRD. `p58` (fusion), `p60` (`C_fusion` 0.5922 < `B_geometry` 0.5976) and
`p55` (objective) all failed to. So H6 is well-evidenced as a **description** and
unproven as a **lever** — and a model paper needs the lever, not the description.
